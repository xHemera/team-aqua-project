        ...
        <section className="w-full h-full rounded-3xl border border-[#c9a227]/25 bg-black/15 p-8 shadow-2xl overflow-y-auto">
          ...
          <div className="space-y-6 text-gray-300">
            <section>
              ...
              <p>
                Welcome to our RPG platform. We are committed to protecting your privacy and ensuring you have a positive experience on our site. This document outlines our privacy policy.
              </p>
            </section>
          </div>
        </section>
