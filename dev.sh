...
start_services() {
    ...
    docker compose -f docker-compose.yml exec -T frontend pnpm prisma generate
    docker compose -f docker-compose.yml exec frontend pnpm prisma migrate dev --name init --url "postgresql://postgres:postgres@db:5432/aqua_temp"
}
...
restart_services() {
    ...
    docker compose -f docker-compose.yml exec -T frontend pnpm add prisma generate
    docker compose -f docker-compose.yml exec frontend pnpm add prisma migrate dev --name init --url "postgresql://postgres:postgres@db:5432/aqua_temp"
